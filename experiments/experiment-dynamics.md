...
![Przykład histogramu wyliczonego dla ścieżki 1 utworu nr 2433 ze zbioru MusicNet. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-histogram-musicnet-2433-t1.png)  
...
![Przykład macierzy przejść wyliczonej dla ścieżki 1 utworu nr 2433 ze zbioru MusicNet. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-matrix-musicnet-2433-t1.png)  
&nbsp;*<span id="rys-5">Rys. 5</span>. Przykład macierzy przejść wyliczonej dla ścieżki 1 utworu nr 2433 ze zbioru MusicNet. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]*
...
![Przykład macierzy przejść wyliczonej dla ścieżki 1 utworu nr 2433 ze zbioru MusicNet z wyzerowaną główną przekątną. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-matrix-zero-musicnet-2433-t1.png)  
...
![Miara zmienności wyliczona dla ścieżki 1 utworu nr 2433 ze zbioru MusicNet. W pierwszym wierszu metryka w trybie podstawowym, w drugim i trzecim w trybie poziomów[^logicpro] i dla różnych kategorii zmienności](./img/dynamics-variability-musicnet-2433-t1.png)  
...
![Histogram wyliczony dla ścieżki 1 utworu nr 2186 ze zbioru MusicNet. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-histogram-musicnet-2186-t1.png)  
...
![Macierz przejść wyliczona dla ścieżki 1 utworu nr 2186 ze zbioru MusicNet. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-matrix-musicnet-2186-t1.png)  
...
![Macierz przejść wyliczona dla ścieżki 1 utworu nr 2186 ze zbioru MusicNet z wyzerowaną główną przekątną. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-matrix-zero-musicnet-2186-t1.png)  
...
![Miara zmienności wyliczona dla ścieżki 1 utworu nr 2186 ze zbioru MusicNet. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-variability-musicnet-2186-t1.png)  
...
![Histogram wyliczony dla ścieżki 0 utworu nr 2213 ze zbioru MusicNet. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-histogram-musicnet-2213-t0.png)  
...
![Macierz przejść wyliczona dla ścieżki 0 utworu nr 2213 ze zbioru MusicNet. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-matrix-musicnet-2213-t0.png)  
...
![Macierz przejść wyliczona dla ścieżki 0 utworu nr 2213 ze zbioru MusicNet z wyzerowaną główną przekątną. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-matrix-zero-musicnet-2213-t0.png)  
&nbsp;*<span id="rys-14">Rys. 14</span>. Macierz przejść wyliczona dla ścieżki 0 utworu nr 2213 ze zbioru MusicNet z wyzerowaną główną przekątną. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]*

![Miara zmienności wyliczona dla ścieżki 0 utworu nr 2213 ze zbioru MusicNet. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-variability-musicnet-2213-t0.png)  
...
![Histogram wyliczony dla ścieżki 1 utworu nr 1777 ze zbioru MusicNet. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-histogram-musicnet-1777-t1.png)  
...
![Macierz przejść wyliczona dla ścieżki 1 utworu nr 1777 ze zbioru MusicNet. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-matrix-musicnet-1777-t1.png)  
...
![Macierz przejść wyliczona dla ścieżki 1 utworu nr 1777 ze zbioru MusicNet z wyzerowaną główną przekątną. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-matrix-zero-musicnet-1777-t1.png)  
...
![Miara zmienności wyliczona dla ścieżki 1 utworu nr 1777 ze zbioru MusicNet. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-variability-musicnet-1777-t1.png)  
...
![Histogram wyliczony dla ścieżki 0 utworu nr 720 ze zbioru MAESTRO-V3. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-histogram-maestro-720-t0.png)  
...
![Macierz przejść wyliczona dla ścieżki 0 utworu nr 720 ze zbioru MAESTRO-V3. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-matrix-maestro-720-t0.png)  
&nbsp;*<span id="rys-21">Rys. 21</span>. Macierz przejść wyliczona dla ścieżki 0 utworu nr 720 ze zbioru MAESTRO-V3. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]*

![Macierz przejść wyliczona dla ścieżki 0 utworu nr 720 ze zbioru MAESTRO-V3 z wyzerowaną główną przekątną. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-matrix-zero-maestro-720-t0.png)  
...
![Miara zmienności wyliczona dla ścieżki 0 utworu nr 720 ze zbioru MAESTRO-V3. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-variability-maestro-720-t0.png)  
...
![Histogram wyliczony dla ścieżki 0 utworu nr 451 ze zbioru MAESTRO-V3. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-histogram-maestro-451-t0.png)  
...
![Macierz przejść wyliczona dla ścieżki 0 utworu nr 451 ze zbioru MAESTRO-V3. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-matrix-maestro-451-t0.png)  
...
![Macierz przejść wyliczona dla ścieżki 0 utworu nr 451 ze zbioru MAESTRO-V3 z wyzerowaną główną przekątną. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-matrix-zero-maestro-451-t0.png)  
...
![Miara zmienności wyliczona dla ścieżki 0 utworu nr 451 ze zbioru MAESTRO-V3. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-variability-maestro-451-t0.png)  
...
![Histogram wyliczony dla ścieżki 0 utworu nr 0 ze zbioru stanowiącego przetworzenie utworu nr 2186 ze zbioru MusicNet. Po lewej metryka w trybie podstawowym, po histogram w trybie poziomów[^logicpro]](./img/dynamics-histogram-rand-000-t0.png)  
...
![Macierz przejść wyliczona dla ścieżki 0 utworu nr 0 ze zbioru stanowiącego przetworzenie utworu nr 2186 ze zbioru MusicNet. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-matrix-rand-000-t0.png)  
...
![Macierz przejść wyliczona dla ścieżki 0 utworu nr 0 ze zbioru stanowiącego przetworzenie utworu nr 2186 ze zbioru MusicNet z wyzerowaną główną przekątną. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-matrix-zero-rand-000-t0.png)  
...
![Miara zmienności wyliczona dla ścieżki 0 utworu nr 0 ze zbioru stanowiącego przetworzenie utworu nr 2186 ze zbioru MusicNet. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-variability-rand-000-t0.png)  
...
![Histogram wyliczony dla ścieżki 0 utworu nr 1 ze zbioru stanowiącego przetworzenie utworu nr 2186 ze zbioru MusicNet. Po lewej metryka w trybie podstawowym, po histogram w trybie poziomów[^logicpro]](./img/dynamics-histogram-rand-001-t0.png)  
&nbsp;*<span id="rys-32">Rys. 32</span>. Histogram wyliczony dla ścieżki 0 utworu nr 1 ze zbioru stanowiącego przetworzenie utworu nr 2186 ze zbioru MusicNet. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]*

![Macierz przejść wyliczona dla ścieżki 0 utworu nr 1 ze zbioru stanowiącego przetworzenie utworu nr 2186 ze zbioru MusicNet. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-matrix-rand-001-t0.png)  
...
![Macierz przejść wyliczona dla ścieżki 0 utworu nr 1 ze zbioru stanowiącego przetworzenie utworu nr 2186 ze zbioru MusicNet z wyzerowaną główną przekątną. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-matrix-zero-rand-001-t0.png)  
...
![Miara zmienności wyliczona dla ścieżki 0 utworu nr 1 ze zbioru stanowiącego przetworzenie utworu nr 2186 ze zbioru MusicNet. Po lewej metryka w trybie podstawowym, po prawej w trybie poziomów[^logicpro]](./img/dynamics-variability-rand-001-t0.png)  
