...
- The Lakh MIDI Dataset [^lakh_MIDI] [^colin_raffel] - Największy z oferowanych zbiorów danych. Zawiera 176 581 różnych utworów w formacie MIDI. 45 tys. z nich znalazło dopasowanie w wpisach z zestawu danych 'Million Song Database'. 'The Lakh MIDI Dataset' powstał przy pomocy wygenerowanych przez użytkowników plików oraz plików podebranych z internetu. Na wskutek tego w zbiorze istnieje znaczne zaszumienie. Wiele piosenek składa się wyłącznie z kilku nut. Na podstawie tego zestawu danych powstał zestaw 'Lakh Pianoroll Dataset' [^lakh_pianoroll], który po oczyszceniu z zbędnego szumu zawiera 174 154 plików. Ten zestaw został później wykorzystany w wytrenowaniu modelu MuseGAN [^dong2017].
...
[^lakh_MIDI]: ["The Lakh MIDI Dataset", Collin Raffel, accessed 14.11.2023](https://colinraffel.com/projects/lmd/)
[^colin_raffel]: ["Learning-Based Methods for Comparing Sequences, with Applications to Audio-to-MIDI Alignment and Matching", Collin Raffel, 2016](https://academiccommons.columbia.edu/doi/10.7916/D8N58MHV)
[^lakh_pianoroll]: ["Lakh Pianoroll Dataset", Hao-Wen Dong et al., accessed 17.11.2023](https://salu133445.github.io/lakh-pianoroll-dataset/)
